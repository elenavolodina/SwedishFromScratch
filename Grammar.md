...
[3. Pronomen. Местоимения.](#3-pronomen-местоимения) 
  ...
  - [Personliga pronomen. Личные местоимения.](#personliga-pronomen-личные-местоимения)
...
Еще примеры глаголов из группы 1: 
...
Эта группа делится на "сильные глаголы" и "неправильные глаголы". "Неправильные глаголы" надо запомнить наизусть. "Сильные глаголы" изменяют гласную и окончание. Несколько примеров:
...
|komma 	|kommer 	|kom 	|kommit|(придти)|
...
### Obestämd och bestämd form. Неопределенная и определенная форма.
...
### Personliga pronomen. Личные местоимения.
